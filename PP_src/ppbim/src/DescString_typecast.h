...
#ifndef _DESCSTRINGTYPECEST_H
#define _DESCSTRINGTYPECEST_H


class DescString_typecast : PPMpeg7Desc
{
public:
	bool m_bTypecast;
	int m_nSubtype;
	DescString *m_pValue;
	TextualType *m_pValueTextual;
	UniqueIDType *m_pValueUID;
