...
#ifndef _TEXTUALTYPE_H
#define _TEXTUALTYPE_H

// FreeTextAnnotation, Title, ...
// TextualType, TitleType, NameComponent

class TextualType : PPMpeg7Desc
{
public:
	DescString *m_pLang;
	DescString *m_pValue;
