...
#ifndef _MEDIAINFORMATIONTYPE_H
#define _MEDIAINFORMATIONTYPE_H

XERCES_CPP_NAMESPACE_USE
class MediaInformationType : PPMpeg7Desc
{
public:

	DescString *m_pId;
	int m_nProfileCount;
	MediaProfileType **m_ppMediaProfile;
