...
#ifndef _CSVALUES_ANONYMOUSTYPE_H
#define _CSVALUES_ANONYMOUSTYPE_H

XERCES_CPP_NAMESPACE_USE
class CSValues_anonymousType : PPMpeg7Desc
{
public:
	int m_nFormatLength;
	int m_nMax;
...
#endif // _CSVALUES_ANONYMOUSTYPE_H
