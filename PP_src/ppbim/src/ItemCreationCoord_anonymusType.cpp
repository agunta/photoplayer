...
ItemCreationCoord_anonymusType::ItemCreationCoord_anonymusType()
{
	m_pLocation = NULL;
	m_pDate = NULL;
}
...
bool ItemCreationCoord_anonymusType::BuildFromXML(DOMNode *node)
{
...
int ItemCreationCoord_anonymusType::GetNumberOfBits()
{
	int bitCount = 0;
	bitCount++;
...
bool ItemCreationCoord_anonymusType::Validate()
{
	return true;
}

bool ItemCreationCoord_anonymusType::WriteBitstream(BitstreamWriter *writer)
{
	bool bret = true;
...
bool ItemCreationCoord_anonymusType::ReadBitstream(BitstreamReader *reader)
{
...
void ItemCreationCoord_anonymusType::PrintXML(std::ostream *fout, int nIndentLevel)
{
	if(!fout) return;
