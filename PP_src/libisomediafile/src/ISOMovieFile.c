...
*/
/*
  $Id: ISOMovieFile.c,v 1.0 2000/08/09 01:44:15 rtm Exp $
*/
...
ISOWriteMovieToFile( ISOMovie theMovie, const char *filename )
{
	...
	{
		case ISOMPEG4FileType:
			err = MP4WriteMovieToFile( theMovie, filename );
			break;
			
		case ISOStillJPEG2000FileType:
			BAILWITHERROR( ISOBadParamErr )		/* not yet implemented */
			break;
			
		case ISOMotionJPEG2000FileType:
			err = MJ2WriteMovieToFile( theMovie, filename );
			break;
			
		case ISOQuickTimeFileType:
			err = QTWriteMovieToFile( theMovie, filename );
			break;
