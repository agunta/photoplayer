...
*/
/*
	$Id: MP4SLPacket.c,v 1.13 1999/12/17 07:47:20 mc Exp $
*/
#include "MP4Movies.h"
#include "MP4Atoms.h"
...
{
	MP4Err makeESD( MP4Movie theMovie, int trackNumber, u64 cts, MP4SLConfig slconfig, MP4DescriptorPtr *outDesc );
