...
#define TRACK_READER_ENTRIES \
	...
	MP4Err (*getNextAccessUnit)( struct MP4TrackReaderStruct* self, MP4Handle outAccessUnit, u32 *outSize, u32 *outSampleFlags, u32 *outCTS, u32 *outDTS, u32 *outDuration ); \
